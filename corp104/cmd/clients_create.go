...
func init() {
	...
	clientsCreateCmd.Flags().String("request_object_signing_alg", "ES256", "Define the algorithm that be used for signing Request Objects sent to the OP")
	...
	clientsCreateCmd.Flags().String("jwks", "", "Define the JSON Web Key Set should be use when performing the \"private_key_jwt\" client authentication method")
